...
public class GameConfiguration : MonoBehaviour
{
    ...
    Word[] words = new Word[]
    {
        new Word("RABBIT", "There are about 50 known species of rabbits!"),
        new Word("HORSE", "Horse Nails are called HOOF"),
        new Word("TURKEY", "There is a country named TURKEY!"),
        new Word("KITTEN", "Kittens Love Play with you! :)"),
        new Word("DOGS", "Dogs have been domestic 9000 years ago!!"),
        new Word("DINOSAUR", "If you see a Dinosaur, please see a DOCTOR!"),
        new Word("TIGER", "Tigers are just BIG CATS! Don't try to Hug them!"),
        new Word("MONKEY", "The Biggest Monkeys are Mandrel Monkeys. "),
        new Word("PENGUIN", "There are no penguins in the Northern Hemisphere, including the North Pole"),
        new Word("POLARBEAR", "Polar bear feeds on fish and seals"),
        new Word("SNAKE", "Snakes are legless but they can crawl and move "),
        new Word("BUTTERFLY", "Butterfly lives more than one day!"),
        new Word("SPIDER", "There are 43.244 known species of Spiders. Wow!"),
        new Word("ELEPHANT", "Elephants can grow up to 6.5 meters. So Tall!!"),
        new Word("ASIA", "Asian name was first used by Heredot."),
        new Word("EUROPE", "Europe is a Peninsula!"),
        new Word("AFRICA", "Africa contains 24,4 percent of the land in the world"),
        new Word("ANTARCTICA", "Antarctica is the world's refrigerator!"),
        new Word("NORTHAMERICA", "There are 23 countries in North America"),
        new Word("SOUTHAMERICA", "More than 371.000.000 people lives in South America."),
        new Word("AUSTRALIA", "The best known animal in Australia is kangaroo!!"),
        new Word("WATERMELON", "92% of Watermelon is Water!"),
    ...
    private void Initialize()
    {
        ...
        CameraControll cam = FindObjectOfType<CameraControll>();
        cam.Tracked = false;
